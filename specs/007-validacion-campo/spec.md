...
**Feature:** `007-validacion-campo` · **Creada:** 2026-09-06 · **Actualizada:** 2026-09-07 · **Versión:** 0.3.0 · **Estado:** borrador.
...
- **FR-009:** DEBE medir bytes transferidos, velocidad efectiva de subida, cola, arranque, cómputo, revisión y tiempo total hasta obtener el resultado; registrar costo de GPU, CPU/RAM, almacenamiento y transferencia por campaña. Congelar presupuesto y objetivo de tiempo total antes de abrir la prueba; informar incumplimientos aunque el conteo sea correcto.
- **FR-010:** DEBE comprobar cargas reanudables, integridad, acceso privado, recuperación de trabajos al cerrar el navegador y persistencia de correcciones. Estas pruebas de servicio no vuelven a abrir el supuesto de disponibilidad de electricidad e internet.
...
- **SC-006 — Operación y evidencia:** preparación/detección de hasta 10 minutos de video en hasta 30 minutos de cómputo en el entorno documentado, conforme a 004; subida, cola y arranque se informan por separado junto al tiempo total. 100% de paquetes cerrados son reconstruibles y ningún caso deliberado de cobertura incompleta/duda abierta permite un total revisado.
- **SC-007 — Servicio remoto:** todas las pruebas de FR-010 preservan integridad y aislamiento; cada campaña informa tiempos y costos de FR-009 y cumple los límites congelados de costo y tiempo total para continuar como piloto en nube. No hay todavía valores aprobados ni mediciones para estos límites.

## Regla de decisión

- **Continuar con un piloto mayor:** se cumplen SC-001–SC-007 en el escenario probado. El tamaño inicial permite una decisión exploratoria, no una garantía comercial de exactitud.
