...
**Fecha:** 2026-09-06 · **Versión revisada:** 0.2.0 · **Alcance:** documentación. No es el resultado de ejecutar `speckit.analyze`, ni una validación del POC.
...
| Procesar originales sin conexión | 002 FR-001/008; 004 FR-005 | Importación y proceso local con red desconectada |
...
| Decidir si el POC sirve | 007 FR-001–008; SC-001–006 | Informe con error, aceptación, esfuerzo y decisión |
...
- [x] CHK008 Los documentos se limitan a especificaciones y principios; no se afirma que haya código, CLI instalada, planes o tareas generadas.
...
El escenario corral/grupo reunido quedó confirmado por el usuario. Restan tamaño y densidad del grupo, dimensiones y estructuras, computadora, método físico de referencia y calendario máximo de prueba. Los checklists revisan la claridad del borrador y no representan aprobación de estos supuestos restantes.
