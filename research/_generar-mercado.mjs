...
function footer(prefix = "") {
  return `<footer class="footer">Dossier vivo · versión 0.6 · corte 23 ago 2026 · dos vías separadas · <a href="${prefix}supuestos-mercado.html">supuestos de mercado</a> · <a href="${prefix}preguntas-mercado.html">preguntas de diligencia</a></footer>`;
}
