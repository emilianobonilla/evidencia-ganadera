...
const items = [
  ...
  },
  {
    ...
    strategy: "Corregido en la v0.5: no es un jugador argentino a vigilar de lejos sino un competidor local activo. Tratarlo como módulo de cobertura de lote y posible aliado; comparar costo/tiempo y explorar si sus videos y resultados pueden incorporarse a un paquete de evidencia con RFID terrestre.",
  ...
  },
  {
    ...
    strategy: "Incorporado en la v0.5 tras revisión externa. Estudiar cómo define y defiende “tamper-resistant” antes de diseñar la procedencia propia; evaluar la caravana satelital como sensor de ubicación de una muestra centinela.",
  ...
  },
  {
    ...
    strategy: "Incorporado en la v0.5 tras revisión externa. Evaluarlo como receptor natural del evento en la modalidad feedlot, junto a Baqueano en Uruguay; verificar API y disposición a integrar eventos firmados de terceros.",
...
function footer(prefix = "") {
  return `<footer class="footer">Dossier vivo · versión 0.5 · corte 23 ago 2026 · revisión externa incorporada · <a href="${prefix}supuestos-mercado.html">supuestos de mercado</a> · <a href="${prefix}preguntas-mercado.html">preguntas de diligencia</a></footer>`;
}
...
function marketPage() {
  ...
  <main>
    <section class="hero"><div><p class="eyebrow">Documento 04 · Mercado</p><h1>La competencia viene por piezas.</h1><p class="lede">Diecisiete fichas separan captura de peso, gestión, ubicación y confianza. El hueco no es “otra balanza”: es un evento RFID–foto–peso–ubicación cuya procedencia pueda defenderse.</p></div><aside class="meta-card"><dl><dt>Versión</dt><dd>0.5</dd><dt>Ítems</dt><dd>17</dd><dt>Geografía</dt><dd>Uruguay + comparables</dd><dt>Corte</dt><dd>23 ago 2026</dd><dt>Orientación</dt><dd>Construir / integrar / aliar</dd></dl></aside></section>
    <div class="layout"><aside class="toc"><strong>Contenido</strong><a href="#respuesta">Respuesta ejecutiva</a><a href="#matriz">Matriz</a><a href="#direct">Directos</a><a href="#substitute">Sustitutos</a><a href="#similar">Similares</a><a href="#evolution">Evolutivos</a><a href="#metodo">Método</a></aside><article class="content">
      <section class="section" id="respuesta"><p class="eyebrow">Respuesta ejecutiva</p><h2>Seis decisiones que deja el mapa</h2><div class="grid grid--2">
        ...
        <div class="card"><span class="number">3</span><h3>El dron domina cobertura, no identidad</h3><p>GanaderIA ofrece una ruta potente para conteo/lote, con límites de pesaje transparentes y sin enlace SNIG público. <strong>Corrección v0.5:</strong> es una startup uruguaya, no argentina; compite en casa.</p></div>
        ...
        <div class="card card--strong"><span class="number">5</span><h3>La ventaja puede estar en la prueba</h3><p>CattleProof muestra que captura, registro inalterable y verificación independiente son capas distintas; Ceres Tag muestra que la procedencia también puede anclarse en el hardware. Esa separación es clave para la auditoría financiera.</p></div>
        <div class="card card--risk"><span class="number">6</span><h3>La demanda de la etapa 2 ya se manifestó</h3><p>El colapso de los fondos ganaderos uruguayos dejó un déficit de US$272 millones y ganado declarado que no existía: en un caso, contratos por ~28.000 animales frente a nueve vacunos hallados por el MGAP. Es la validación más fuerte —y más urgente— del producto de auditoría.</p></div>
      </div><div class="callout"><strong>Posicionamiento sugerido:</strong> “captura verificable de existencia, identidad, tendencia de peso y ubicación” para decisiones productivas primero y evidencia financiera después. <strong>Tensión declarada en la v0.5:</strong> el diferencial defendible pesa más en la etapa 2 que en la etapa 1, y la ventana de la etapa 2 está abierta ahora.</div>
...
const marketAssumptions = [
  ...
  ["M13","Crítico","La ventana de la etapa de auditoría está abierta ahora y puede cerrarse sola.","Nuevo en la v0.5. El BCU advirtió desde 2022 sobre estos esquemas, redactó cambios regulatorios en 2025 para ampliar la supervisión sobre la captación masiva de recursos y hoy hay fiscalías, fiduciarios y damnificados buscando cómo verificar existencias. Si el estándar probatorio lo termina fijando el regulador o un competidor, llegar después vale mucho menos que llegar temprano a esa conversación. Esto tensiona la secuencia “feedlot primero, auditoría después”, que fue decidida por razones operativas y no comerciales.","Entrevistar al regulador, a fiduciarios y a auditores mientras se ejecuta el descubrimiento de feedlot, no después; seguir el texto de la nueva normativa.","Si la regulación fija un mínimo que no requiere evidencia técnica, o si la ventana se cierra, la etapa 2 vuelve a ser una apuesta de largo plazo y el feedlot debe sostener el negocio por sí solo."],
];
...
const marketQuestions = [
  ...
  ["MQ25","P0 · Regulación","¿Qué verificación de existencias exigirá la nueva supervisión del BCU sobre la captación de fondos ganaderos, y quién deberá firmarla?","BCU, asesores legales, fiduciarios y auditores","Nueva en la v0.5. Si el estándar probatorio lo fija la regulación, conviene estar en esa conversación antes de que se cierre; también define si el comprador del informe es el fondo, el fiduciario o el propio regulador."],
  ["MQ26","P1 · Caso real","En el colapso de los fondos ganaderos, ¿qué control habría detectado el faltante y en qué momento del ciclo?","Síndicos, fiduciarios, auditores y damnificados","Nueva en la v0.5. Convierte un fraude documentado —contratos por miles de animales frente a un puñado hallado en el lugar declarado— en casos de prueba concretos para el paquete de evidencia."],
];
